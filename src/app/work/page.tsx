  ...
  return (
    <main className="flex-grow pt-[104px] pb-24 md:pb-12 px-4 md:px-16 w-full max-w-7xl mx-auto flex flex-col gap-12">
      ...
      <div className="relative">
        {/* Horizontal Connecting Line between cards */}
        <div className="hidden lg:block absolute top-1/2 left-6 right-6 h-[2px] -translate-y-1/2 bg-gradient-to-r from-primary/30 via-primary to-primary/30 pointer-events-none z-0">
          <div className="w-full h-full bg-gradient-to-r from-transparent via-white/80 to-transparent animate-pulse"></div>
        </div>
      ...
      {/* Animated Divider */}
      <div className="w-full flex justify-center py-6" data-aos="fade-up">
